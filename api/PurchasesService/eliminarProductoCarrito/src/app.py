...
def eliminar_producto_carrito():
    ...
    try:
        ...
        try:
            ...
            cur.execute("select * from detalle_carrito d inner join Producto p on d.id_producto = p.sku inner join Categoria c on c.id_categoria = p.id_categoria where p.sku = "+str(form.idProducto.data)+" and d.id_usuario = "+str(cui)+" and d.estado = 'P';")
            if cur.rowcount > 0:
